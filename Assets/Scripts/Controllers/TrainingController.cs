...
public class TrainingController : MonoBehaviour
{
    ...
    [SerializeField]
    private GameObject _startTraining2;
    [SerializeField] 
    private GameObject _training3;
    [SerializeField] 
    private GameObject _training3Coll;
    [SerializeField]
    private GameObject _startTraining3;

    private void Start()
    {
        _startTraining2.gameObject.SetActive(false);
        _startTraining3.gameObject.SetActive(false);
    }
    ...
    public void ChangeTraining()
    {
        ...
        else if(_training1Finish == true && _training2Finish == false)
        {
            ...
            _startTraining2.gameObject.SetActive(true);
        }
        else if (_training1Finish == true && _training2Finish == true)
        {
            ...
            _startTraining3.gameObject.SetActive(true);
        }
    }
